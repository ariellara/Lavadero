...
<body>
	...
	<div class="easyui-panel" title="Nueva Categoria" style="width:100%;max-width:400px;padding:10px 80px;">
		<form id="ff" method="post">
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" id="codigo_categoria" style="width:100%" data-options="label:'Codigo:',required:true">
			</div>
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" id="nombre_categoria" style="width:100%" data-options="label:'Nombre:',required:true">
			</div>
				
		<div style="text-align:center;padding:5px 0">
			<input type=button class="btn btn-primary" value = Guardar onclick="recojerDatos(1,1)">
