...
<head>
	...
	<h1 class="page-header">
				...
				<a href = "new_producto.php" class="btn btn-success" target = admin>Nuevo Producto</a>
				</span>
             </h1> 
	   <table id="dg" align=center class="easyui-datagrid" title="Producto"  style="width:700px;height:340px; ">
		   ...
		   <thead>
			   <tr>
                   ...
                   <th data-options="field:'f_cat',width:260">Categoria</th>
